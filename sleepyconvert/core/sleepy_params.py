"""sleepyconvert's slice of the shared "sleepy utils" configuration.
...
sleepyconvert the shorthand is ``convert``.
...
DEFAULT_PARAMS_SNIPPET = """# sleepyconvert
