"""CLI tests for CSV and Excel conversions."""
...
def testCsvToXlsx(tmp_path: Path) -> None:
    """Verify CSV files can be converted into Excel files.
...
def testXlsxToCsv(tmp_path: Path) -> None:
    """Verify Excel files can be converted into CSV files.
